...
# python SSRNET_train.py --input ../data/6x_data_aligned.npz --db age_ssrnet --netType1 4 --netType2 4
...
#        f.write(model.to_json())
    ...
    model.save(os.path.join(db_name+"_models/"+save_name, save_name+'.saveh5'), overwrite=True)
